...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ProductDto patchSpecialCategories(Long id, ProductSpecialCategoriesPatchDto specialCategoriesDto) {
        Product product = productRepository.findById(id)
            .orElseThrow(() -> new ResourceNotFoundException("Producto no encontrado con ID: " + id));

        // Actualizar solo los campos proporcionados
        if (specialCategoriesDto.esDestacado() != null) {
            product.setEsDestacado(specialCategoriesDto.esDestacado());
        }
        if (specialCategoriesDto.esNovedad() != null) {
            product.setEsNovedad(specialCategoriesDto.esNovedad());
        }
