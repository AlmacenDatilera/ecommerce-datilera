...
public class ProductController {
    ...
    @PatchMapping("/{id}")
    public ProductDto patchSpecialCategories(@PathVariable Long id, @RequestBody ProductSpecialCategoriesPatchDto specialCategoriesDto) {
        return productService.patchSpecialCategories(id, specialCategoriesDto);
    }
}
